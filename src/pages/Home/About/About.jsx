...
const About = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div className='lg:w-1/2 space-y-5 p-4'>
      ...
      <p className="py-6">the majority have suffered alteration in some form, by injected humour, or random words which do not look even slightly believable.</p>
      <button className="btn btn-warning bg-[#FF3811] text-white">Get More Info</button>
    </div>
  </div>
</div>
    );
